...
class BigDepthParameterState(EventState):
	"""
	...
	def __init__(self, topic, depth):
		"""Constructor"""
		super(BigDepthParameterState, self).__init__(outcomes=['Success', 'Failure'])
		self._topic = topic
		self._depth = depth
	...
	def on_enter(self, userdata):
		Logger.loginfo('Moving to depth %f'%self._depth)
		self.client.send_goal(self._topic, riptide_controllers.msg.GoToDepthGoal(self._depth))